...
// Tracks when we last sent a high-resolution live sample to the Mac.
unsigned long lastLiveSampleMs = 0;


  // completedInterval tells us how many complete 60-second periods have
  // already finished.
  //
  // millis() - intervalStartMs tells us how far we are into the current one.
  //
  // Combining them gives a useful elapsed time for graphing even though we
  // do not yet have a real-time clock.
